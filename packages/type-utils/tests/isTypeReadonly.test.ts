  ...
  describe(AST_NODE_TYPES.TSTypeAliasDeclaration, () => {
    ...
    describe('default options', () => {
      ...
      function runTestIsReadonly(
        ...
        { expect }: Partial<TestContext> & Pick<TestContext, 'expect'>,
      ): void {
        runTestForAliasDeclaration(code, options, true, expect);
      }
      ...
      function runTestIsNotReadonly(
        ...
        runTestForAliasDeclaration(code, options, false, expect);
      }
      ...
      describe('IndexSignature', () => {
        ...
        describe('is not readonly circular', () => {
          ...
          it('handles circular mutable PropertySignature', () => {
            runTests(['interface Test { [key: string]: Test };'], { expect });
          });
